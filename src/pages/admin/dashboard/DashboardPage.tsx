...
function DashboardPage() {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/+573207199008', '_blank');
  };
  ...
  return (
    <div className='relative'>
      <div className="p-2 h-full w-full scrollbar-hide overflow-y-auto">
        {
          /**
        ...
        <ScrollArea className='h-[90vh] w-full'>
          <div className="flex flex-col md:flex-row gap-2 w-full pb-4">
                    ...
                    <div className='flex flex-col gap-2'>

                      {
                        summary?.ordenesEnProceso.ordenes.map((orden) => (
                          ...
                          >
                            <div className='flex flex-col'>
                              <span className=''>ID: {orden.id.toString().split('-')[0]}</span>
                              <span className='font-medium'>Total: ${orden.total_price?.toLocaleString() ?? "0"}</span>
                            </div>
                            <div className='flex flex-col items-center gap-2'>
                              <p className='text-sm'>{orden.createAt?.toLocaleString().split('T')[0] ?? "0"}</p>
